...
const (
	Predictor_Predict_FullMethodName = "/predictor.Predictor/Predict"
)
...
func (c *predictorClient) Predict(ctx context.Context, in *PredictionRequest, opts ...grpc.CallOption) (*PredictionResponse, error) {
...
func (UnimplementedPredictorServer) Predict(context.Context, *PredictionRequest) (*PredictionResponse, error) {
...
func _Predictor_Predict_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PredictorServer).Predict(ctx, req.(*PredictionRequest))
	}
